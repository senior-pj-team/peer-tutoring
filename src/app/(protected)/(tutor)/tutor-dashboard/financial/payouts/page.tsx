...
import PayoutList from "@/components/app/features/tutor/tutor-dashboard/financial/tutor-payout-list";
...
export default async function page() {
  ...
  const dateFilterCol = "paid_out_at";
  const status: TStudentSessionStatus[] = ["paid"];
  ...
  return (
    <HydrationBoundary state={dehydrate(queryClient)}>
      <PayoutList tutor_id={user?.user_id} />
    </HydrationBoundary>
  );
}
