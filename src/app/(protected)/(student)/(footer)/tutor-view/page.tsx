...
import Reviews from "@/components/app/features/rating-review/reviews";
	...
	return (
		<>
					...
					<div>
						...
						<div className="mt-6">
							...
							<p className="my-6 text-xl">
								Experienced tutor helping students master Math and Coding with
			...
			<div className="xl:px-30 px-5 my-6">
				...
				<h1 className="text-lg font-bold mt-7">Sessions offered by John Doe</h1>
