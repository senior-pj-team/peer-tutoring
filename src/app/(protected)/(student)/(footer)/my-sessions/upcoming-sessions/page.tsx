  ...
  const sessions = [
    {
      ...
      tutorName: "John Doe",
      tutorRating: 4.8,
      description: "Dive deep into modern web development techniques, covering both frontend and backend technologies...",
    ...
    },
    {
      ...
      tutorName: "Chen Ming",
      tutorRating: 4.8,
      description: "Develop the language skills needed for effective communication in a Chinese business environment.",
    ...
    },
    {
      ...
      tutorName: "Li Wei",
      tutorRating: 4.9,
      description: "Learn the basics of Mandarin Chinese including pronunciation, basic grammar, and conversation practice.",
      requirements: "No prior Chinese knowledge required. Willingness to practice speaking is a must.",
      date: "May 15, 2025",
      startTime: "9:00 AM",
      endTime: "11:00 AM",
      maxStudent: 20,
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
      {sessions.map((session) => (
        <SessionCard
          ...
          remainingTime={getRemainingTime(session.date, session.startTime)}
        />
      ))}
    </div>
  );
