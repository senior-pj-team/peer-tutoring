        ...
        >
          ...
          <div className="flex flex-col gap-y-6">
                  ...
                  <FormControl>
                    <Switch
                      ...
                      onCheckedChange={(checked) => {
                        field.onChange(checked); // update 'paid'
                        if (!checked) {
                          form.setValue("amount", 0); // set amount to 0 when paid is false
                        }
                      }}
                    />
                  </FormControl>
            ...
            <Button
              size="lg"
              type="submit"
              className="md:w-[20%] mx-auto cursor-pointer"
            >
              {isEdit ? <span>Save Changes</span> : <span>Create Session</span>}
            </Button>
          </div>
        </form>
      </Form>
