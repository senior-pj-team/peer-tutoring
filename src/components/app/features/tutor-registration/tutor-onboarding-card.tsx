...
export default function TutorOnboardingCard({
  ...
  const sendResponseEmail =useCallback(async () => {
      ...
      const detail = currentAction=="approve"? "Congratulations you have been approved as a tutor at Orion. Please comply with the terms and conditions as a tutor" : "Sorry, your tutor registration request has been rejected";
    ...
    <>
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex items-start gap-4 flex-1">
            ...
            <div className="space-y-1">
              <h3 className="text-lg font-semibold text-gray-900">
                <Link href={`/student-view/${user.id}`} className="hover:underline">
                  {user.username}
                </Link>
              </h3>
          ...
          <div className="md:w-64 flex flex-col justify-between">
            <div className="space-y-3">
              <h4 className="font-medium text-sm text-gray-800">Bank Information</h4>
            ...
            <div className="flex flex-col gap-2 mt-4">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  disabled={isPending}
                >
                  {isPending && currentAction === "reject" ? <LoadingDots /> : "Reject"}
                </Button>
                <Button
                  variant="default"
                  size="sm"
                  ...
                  disabled={isPending}
                >
                  {isPending && currentAction === "approve" ? <LoadingDots /> : "Approve"}
                </Button>
              </div>
            </div>
          </div>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-5xl md:min-w-[700px]">
          <DialogHeader>
            <DialogTitle className="text-lg font-semibold">Tutor Request Details</DialogTitle>
          </DialogHeader>
          ...
          <div className="flex flex-col md:flex-row gap-6">
            <div className="md:w-1/2">
              {user.studentId_photo ? (
                ...
                <div className="text-sm text-gray-500">No student ID photo provided</div>
              )}
            </div>
            ...
            <div className="md:w-1/2 space-y-2 text-sm text-gray-700">
              ...
              <p><strong>Account Name:</strong> {request.account_name}</p>
              <p><strong>Account No.:</strong> {request.account_number}</p>
              <p><strong>Requested On:</strong> {formatDate(parseISO(request.created_at), "yyyy MMMM dd")}</p>
